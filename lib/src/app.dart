...
import 'record/record_edit_view.dart';
import 'record/record_list_view.dart';
import 'transaction/transaction_edit_view.dart';
            ...
            return MaterialPageRoute<void>(
              ...
              builder: (BuildContext context) {
                switch (routeSettings.name) {
                  ...
                  case RecordEditView.routeName:
                    final args = routeSettings.arguments as String;
                    return RecordEditView(record: args);
                  case RecordListView.routeName:
                    final args = routeSettings.arguments as String;
                    return RecordListView(path: args);
                  default:
...
class RecordListArguments {
  final String path;
  RecordListArguments(this.path);
}
